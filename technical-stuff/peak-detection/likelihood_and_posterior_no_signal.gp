...
set output "likelihood_and_posterior_no_signal.png"
...
#	pp0(x,y) = pl0(x,y)
#	splot[0:11][-1:8] pl0(y,x)
#	splot[0:11][-1:8] pp0(y,x)
#
#	pl1(x,y) = p_l(x,y,Y1,T1,dy,w)
#	pp1(x,y) = pp0(x,y)*pl1(x,y)
#	splot[0:11][-1:8] pl1(y,x) w pm3d
#	splot[0:11][-1:8] pp1(y,x) w pm3d

	pl2(x,y) = p_leading(x,y,Y2,T2,dy,w)
	pp2(x,y) = pl2(x,y) #pp1(x,y)*pl2(x,y)
	set arrow from T2,-1 to T2,8 front nohead lw 1
	set arrow from 0,Y2 to 11,Y2  front nohead lw 1
	set title "likelihood 2"
	splot[0:11][-1:8] pl2(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 2"
	splot[0:11][-1:8] pp2(y,x) w pm3d

	pl3(x,y) = p_leading(x,y,Y3,T3,dy,w)
	pp3(x,y) = pp2(x,y)*pl3(x,y)
	set arrow from T3,-1 to T3,8 front nohead lw 1
	set arrow from 0,Y3 to 11,Y3  front nohead lw 1
	set title "likelihood 3"
	splot[0:11][-1:8] pl3(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 3"
	splot[0:11][-1:8] pp3(y,x) w pm3d

	pl4(x,y) = p_leading(x,y,Y4,T4,dy,w)
	pp4(x,y) = pp3(x,y)*pl4(x,y)
	set arrow from T4,-1 to T4,8 front nohead lw 1
	set arrow from 0,Y4 to 11,Y4  front nohead lw 1
	set title "likelihood 4"
	splot[0:11][-1:8] pl4(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 4"
	splot[0:11][-1:8] pp4(y,x) w pm3d

	pl5(x,y) = p_leading(x,y,Y5,T5,dy,w)
	pp5(x,y) = pp4(x,y)*pl5(x,y)
	set arrow from T5,-1 to T5,8 front nohead lw 1
	set arrow from 0,Y5 to 11,Y5  front nohead lw 1
	set title "likelihood 5"
	splot[0:11][-1:8] pl5(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 5"
	splot[0:11][-1:8] pp5(y,x) w pm3d

	pl6(x,y) = p_trailing(x,y,Y6,T6,dy,w)
	pp6(x,y) = pp5(x,y)*pl6(x,y)
	set arrow from T6,-1 to T6,8 front nohead lw 1
	set arrow from 0,Y6 to 11,Y6  front nohead lw 1
	set title "likelihood 6"
	splot[0:11][-1:8] pl6(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 6"
	splot[0:11][-1:8] pp6(y,x) w pm3d

	pl7(x,y) = p_trailing(x,y,Y7,T7,dy,w)
	pp7(x,y) = pp6(x,y)*pl7(x,y)
	set arrow from T7,-1 to T7,8 front nohead lw 1
	set arrow from 0,Y7 to 11,Y7  front nohead lw 1
	set title "likelihood 7"
	splot[0:11][-1:8] pl7(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 7"
	splot[0:11][-1:8] pp7(y,x) w pm3d

	pl8(x,y) = p_trailing(x,y,Y8,T8,dy,w)
	pp8(x,y) = pp7(x,y)*pl8(x,y)
	set arrow from T8,-1 to T8,8 front nohead lw 1
	set arrow from 0,Y8 to 11,Y8  front nohead lw 1
	set title "likelihood 8"
	splot[0:11][-1:8] pl8(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 8"
	splot[0:11][-1:8] pp8(y,x) w pm3d

	pl9(x,y) = p_trailing(x,y,Y9,T9,dy,w)
	pp9(x,y) = pp8(x,y)*pl9(x,y)
	set arrow from T9,-1 to T9,8 front nohead lw 1
	set arrow from 0,Y9 to 11,Y9  front nohead lw 1
	set title "likelihood 9"
	splot[0:11][-1:8] pl9(y,x) w pm3d, "example_no_signal.dat" using 1:3:(0) w p pt 7 ps 1 lc black notitle
	unset arrow
	set title "posterior 9"
	splot[0:11][-1:8] pp9(y,x) w pm3d

#	pl10(x,y) = p_l(x,y,Y10,T10,dy,w)
#	pp10(x,y) = pp9(x,y)*pl10(x,y)
#	splot[0:11][-1:8] pl10yxxy) w pm3d
#	splot[0:11][-1:8] pp10yxxy) w pm3d
#
#	pl11(x,y) = p_l(x,y,Y11,T11,dy,w)
#	pp11(x,y) = pp10(x,y)*pl11(x,y)
#	splot[0:11][-1:8] pl11yxxy) w pm3d
#	splot[0:11][-1:8] pp11yxxy) w pm3d
